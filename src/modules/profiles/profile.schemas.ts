...
export const createProfileSchema = z
    .object({
        ...
        father_bn: z.string({
            required_error: "Father's Bangla name is required",
        }),
        mother: z.string({ required_error: "Mother's name is required" }),
        mother_bn: z.string({
            required_error: "Mother's Bangla name is required",
        }),
        ...
        mobile: z
            ...
            .regex(bdPhoneRegex, {
                message: "Mobile must be a valid Bangladeshi phone number",
            }),
        confirm_mobile: z
            .string({ required_error: "Confirm mobile is required" })
            .regex(bdPhoneRegex, {
                message:
                    "Confirm mobile must be a valid Bangladeshi phone number",
            }),
